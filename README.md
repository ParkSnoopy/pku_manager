...
- On desktop, Settings can make the window close button either exit to the system tray or close the app. Select the tray icon to reopen the window; its menu can also close the app.
