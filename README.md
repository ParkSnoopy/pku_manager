...
3. If information is incomplete, the app asks only for values it could not parse. Tutorial-room alternatives appear as a direct classroom choice with the class day and periods. **Reject and ignore** cancels the whole import and keeps your existing timetable.
