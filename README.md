...
- Use **Roll colors** repeatedly for another timetable color combination. Settings can edit the Custom palette's color combination, choose a pastel accent or any custom accent, optionally blend that accent into the whole theme, choose Serif or Sans Serif, scale application and timetable text independently, adjust Thin through Black weight, enable dark mode, hide the navigation action, choose any timetable header color, enable automatic text-color inversion for course and schedule colors, and advance through Korean, English, and Simplified Chinese with one language button.
