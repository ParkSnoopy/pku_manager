...
- Wide windows show Monday through Friday together. Scroll vertically for later periods.
...
- Use **Roll colors** repeatedly for another timetable color combination. Settings provides persistent accent and language controls.
- Use **Export** to save the complete Monday–Friday timetable as PNG or XLSX.
