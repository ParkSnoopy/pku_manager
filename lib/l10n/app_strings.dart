...
class AppStrings {
  ...
  static const _values = <String, Map<AppText, String>>{
    'ko': {
      ...
      AppText.fullScreen: '전체 화면',
      AppText.exitFullScreen: '전체 화면 종료',
      ...
      AppText.deleteCourse: '강의 삭제',
      AppText.deleteCourseWarning: '이 강의를 영구적으로 삭제합니다. 관련 일정은 강의 연결 없이 유지됩니다.',
      AppText.theme: '테마',
      ...
      AppText.onApplicationClose: '앱을 닫을 때',
      AppText.exitToSystemTray: '시스템 트레이로 나가기',
      AppText.closeTheApp: '앱 닫기',
      AppText.showApplication: '앱 열기',
      ...
      AppText.blendAccentIntoTheme: '강조 색상을 테마 색상에 혼합',
      AppText.customPalette: '사용자 지정 색상 조합',
      AppText.font: '글꼴',
      AppText.serif: '세리프',
      AppText.sans: '산세리프',
      AppText.timetableFont: '시간표 글꼴',
      AppText.useAppFont: '앱 글꼴 사용',
      AppText.songTi: 'SongTi (SimSun)',
      AppText.heiTi: 'HeiTi (SimHei)',
      ...
      AppText.purgeAppData: '앱 데이터 삭제',
      AppText.purgeAppDataWarning: '모든 시간표, 일정 및 설정을 영구적으로 삭제합니다.',
      AppText.appDataExported: '앱 데이터를 내보냈습니다',
      AppText.appDataImported: '앱 데이터를 가져왔습니다',
      AppText.appDataPurged: '앱 데이터를 삭제했습니다',
      AppText.appDataPurgeFailed: '앱 데이터를 삭제할 수 없습니다',
    ...
    'en': {
      ...
      AppText.fullScreen: 'Full screen',
      AppText.exitFullScreen: 'Exit full screen',
      ...
      AppText.deleteCourse: 'Delete class',
      AppText.deleteCourseWarning: 'This class will be permanently deleted. Related schedules will be kept without a class association.',
      AppText.theme: 'Theme',
      ...
      AppText.onApplicationClose: 'On application close',
      AppText.exitToSystemTray: 'Exit to system tray',
      AppText.closeTheApp: 'Close the app',
      AppText.showApplication: 'Show application',
      ...
      AppText.blendAccentIntoTheme: 'Blend accent color into theme color',
      AppText.customPalette: 'Custom color combination',
      AppText.font: 'Font',
      AppText.serif: 'Serif',
      AppText.sans: 'Sans serif',
      AppText.timetableFont: 'Timetable font',
      AppText.useAppFont: 'Use app font',
      AppText.songTi: 'SongTi (SimSun)',
      AppText.heiTi: 'HeiTi (SimHei)',
      ...
      AppText.purgeAppData: 'Purge app data',
      AppText.purgeAppDataWarning: 'All timetables, schedules, and settings will be permanently deleted.',
      AppText.appDataExported: 'App data exported',
      AppText.appDataImported: 'App data imported',
      AppText.appDataPurged: 'App data purged',
      AppText.appDataPurgeFailed: 'App data could not be purged',
    ...
    'zh': {
      ...
      AppText.fullScreen: '全屏',
      AppText.exitFullScreen: '退出全屏',
      ...
      AppText.deleteCourse: '删除课程',
      AppText.deleteCourseWarning: '此课程将被永久删除。相关日程会保留，但不再关联课程。',
      AppText.theme: '主题',
      ...
      AppText.onApplicationClose: '关闭应用时',
      AppText.exitToSystemTray: '退出到系统托盘',
      AppText.closeTheApp: '关闭应用',
      AppText.showApplication: '显示应用',
      ...
      AppText.blendAccentIntoTheme: '将强调色混入主题色',
      AppText.customPalette: '自定义配色组合',
      AppText.font: '字体',
      AppText.serif: '衬线体',
      AppText.sans: '无衬线体',
      AppText.timetableFont: '课表字体',
      AppText.useAppFont: '使用应用字体',
      AppText.songTi: '宋体 (SimSun)',
      AppText.heiTi: '黑体 (SimHei)',
      ...
      AppText.purgeAppData: '清除应用数据',
      AppText.purgeAppDataWarning: '所有课程表、日程和设置都将被永久删除。',
      AppText.appDataExported: '应用数据已导出',
      AppText.appDataImported: '应用数据已导入',
      AppText.appDataPurged: '应用数据已清除',
      AppText.appDataPurgeFailed: '无法清除应用数据',
