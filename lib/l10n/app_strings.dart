...
class AppStrings {
  ...
  static const _values = <String, Map<AppText, String>>{
    'ko': {
      ...
      AppText.scheduleTime: '시간',
      AppText.scheduleTitleRequired: '일정을 입력하세요',
      AppText.scheduleSaveFailed: '일정을 저장할 수 없습니다',
    ...
    'en': {
      ...
      AppText.scheduleTime: 'Time',
      AppText.scheduleTitleRequired: 'Enter a schedule',
      AppText.scheduleSaveFailed: 'Schedule could not be saved',
    ...
    'zh': {
      ...
      AppText.scheduleTime: '时间',
      AppText.scheduleTitleRequired: '请输入安排',
      AppText.scheduleSaveFailed: '无法保存安排',
