...
- Expose immediate application and timetable text scales, Serif/Sans Serif selection, and every Thin–Black weight in one font section. Render classroom and class names at the same base size with two leading room spaces; wrap prefix-free remarks.
